...
func IgnoreOptions() []goleak.Option {
	return []goleak.Option{
		...
		goleak.IgnoreTopFunction("k8s.io/apiserver/pkg/server.SetupSignalContext.func1"),
...
// It should be called at the beginning of a test.
...
// with standard ignores and klog cleanup. It is intended to be called
// from a TestMain function.
//
// Usage:
//
