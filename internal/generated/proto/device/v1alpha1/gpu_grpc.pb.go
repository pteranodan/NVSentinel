...
const (
	...
	GpuService_PatchGpu_FullMethodName        = "/nvidia.nvsentinel.v1alpha1.GpuService/PatchGpu"
)
...
type GpuServiceClient interface {
	...
	// PatchGpu patches a single GPU resource.
	PatchGpu(ctx context.Context, in *PatchGpuRequest, opts ...grpc.CallOption) (*Gpu, error)
}
...
func (c *gpuServiceClient) PatchGpu(ctx context.Context, in *PatchGpuRequest, opts ...grpc.CallOption) (*Gpu, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Gpu)
	err := c.cc.Invoke(ctx, GpuService_PatchGpu_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GpuServiceServer interface {
	...
	// PatchGpu patches a single GPU resource.
	PatchGpu(context.Context, *PatchGpuRequest) (*Gpu, error)
...
func (UnimplementedGpuServiceServer) PatchGpu(context.Context, *PatchGpuRequest) (*Gpu, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PatchGpu not implemented")
}
...
func _GpuService_PatchGpu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PatchGpuRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GpuServiceServer).PatchGpu(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GpuService_PatchGpu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GpuServiceServer).PatchGpu(ctx, req.(*PatchGpuRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GpuService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PatchGpu",
			Handler:    _GpuService_PatchGpu_Handler,
		},
	},
