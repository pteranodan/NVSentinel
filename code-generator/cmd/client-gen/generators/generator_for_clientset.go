...
func (g *genClientset) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	m := map[string]interface{}{
		...
		"Config":              c.Universe.Type(types.Name{Package: "github.com/nvidia/nvsentinel/pkg/client-go/nvgrpc", Name: "Config"}),
		"ClientConnFor":       c.Universe.Function(types.Name{Package: "github.com/nvidia/nvsentinel/pkg/client-go/nvgrpc", Name: "ClientConnFor"}),
