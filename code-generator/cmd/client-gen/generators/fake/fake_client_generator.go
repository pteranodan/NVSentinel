...
Origin: https://github.com/kubernetes/code-generator/blob/v0.34.1/cmd/client-gen/generators/fake/fake_client_generator.go
*/
...
import (
	...
	scheme "github.com/nvidia/nvsentinel/code-generator/cmd/client-gen/generators/scheme"
...
func TargetForGroup(gv clientgentypes.GroupVersion, typeList []*types.Type, clientsetDir, clientsetPkg string, groupPkgName string, groupGoName string, inputPkg string, boilerplate []byte) generator.Target {
