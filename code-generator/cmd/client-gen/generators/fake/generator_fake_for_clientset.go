...
Origin: https://github.com/kubernetes/code-generator/blob/v0.34.1/cmd/client-gen/generators/fake/generator_fake_for_clientset.go
*/
...
func (c *Clientset) ClientConn() $.grpc|raw$ {
	return nil
}
